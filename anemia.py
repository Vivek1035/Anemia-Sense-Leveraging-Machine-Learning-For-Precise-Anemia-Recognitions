...
def main():
    ...
    if st.button("How this was prepared?"):
        ...
        st.markdown("<p style='text-align: left;'> Get complete code at <a href='https://github.com/Vivek1035/Anemia-Sense-Leveraging-Machine-Learning-For-Precise-Anemia-Recognitions'>GitHub Repo </a>  </p>", unsafe_allow_html=True)
    st.markdown("<p style='text-align: center;'> Brought to you with ❤ by <a href='https://github.com/Vivek1035'>Vivek Singh</a>  </p>", unsafe_allow_html=True)
